...
class BinaryTreeTest {
    ...
    void traverseDepthFirst() {
        ...
        binaryTree.add(6);
        binaryTree.add(7);
        final var out = binaryTree.renderDepthFirst();
        assertThat(out).isEqualTo("[value=5, left=2, right=1][value=2, left=6, right=7][value=6, left=null, right=null][value=7, left=null, right=null][value=1, left=null, right=null]");
    }
}
